...
| onMessage script | `cast_resource_servers/products/lung_screening.py` |
...
```bash
pip install aiohttp
python cast_resource_servers/products/lung_screening.py
python cast_resource_servers/products/lung_screening.py --local
```
...
| `cast_py_client/src/cast_client/client.py` | Cast wire protocol (used via `resource_server`) |
