...
Authoritative hub code: `cast_hub/cast_hub.py`. Matching clients:
vtk-js `Sources/IO/Core/CastClient/`, VolView `src/io/cast-client.ts`, OHIF
`extensions/cast`, Slicer `cast_py_client`.
...
| Component | Path |
|-----------|------|
| Hub | `cast_hub/cast_hub.py` |
| Hub docs | `cast_hub/docs/README.md` |
| Python client | `cast_py_client/src/cast_client/client.py` |
...
| Slicer hub loop | `cast_resource_servers/runtime/resource_server_hub.py` |
| Provider scripts | `cast_resource_servers/runtime/cast_provider_runtime.py`, `cast_resource_servers/products/` |
